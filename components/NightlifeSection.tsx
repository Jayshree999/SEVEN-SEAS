...
const venues = [
  ...
  },
  {
    ...
    image: '/nightlife/geoffreys.jpeg',
  ...
  {
    title: 'Vibe Nation',
    image: '/nightlife/vibenation.jpeg',
  ...
  return (
    <Link href={venue.link}>
      <motion.div
        ...
        whileHover={{ y: -6 }}
        className="group relative h-[320px] md:h-[380px] lg:h-[420px] overflow-hidden rounded-none cursor-pointer shadow-sm hover:shadow-2xl transition-all duration-500 border border-white/10 bg-[#1a1a1a]"
      >
        {/* Premium card background glow */}
        <div className="absolute -inset-1 bg-gradient-to-r from-purple-500/0 via-purple-500/10 to-purple-500/0 rounded-none opacity-0 group-hover:opacity-100 transition-opacity duration-700 blur-md"></div>
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-5 md:p-6 z-10">
          ...
          <motion.div
            ...
            className="mb-3"
          >
            <div className="bg-white/95 backdrop-blur-md px-6 py-4 rounded-none shadow-2xl border border-gray-100 inline-block">
              <h3
                className="text-sm md:text-base font-bold text-gray-900 whitespace-nowrap tracking-widest uppercase"
                style={{ fontFamily: 'var(--font-playfair)' }}
              >
                {venue.title}
              </h3>
          ...
          <motion.div
            ...
            className="bg-black/80 backdrop-blur-md px-6 py-4 rounded-none shadow-xl border border-white/10"
          >
            <p className="text-[10px] md:text-xs text-gray-300 leading-relaxed font-light">
              {venue.description}
            </p>
          </motion.div>
        </div>
        ...
        <div className="absolute inset-0 rounded-none border border-transparent group-hover:border-purple-500/30 transition-all duration-500 pointer-events-none"></div>
