      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <Link href="/dining">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            className="group relative h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden rounded-none cursor-pointer shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 bg-white"
          >
