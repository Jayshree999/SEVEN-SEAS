    ...
    <section className="py-12 md:py-16 px-4 sm:px-6 md:px-12 lg:px-24 bg-gradient-to-b from-amber-50/30 via-white to-amber-50/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-8">
            ...
            >
              ...
              <div>
                ...
                >
                  ROVEE
                  <br />
                  <span className="text-2xl md:text-3xl lg:text-4xl">ARABIC CUISINE</span>
                </h2>
              </div>
            </motion.div>
            ...
            >
              <p className="text-xs md:text-sm text-gray-700 leading-relaxed font-medium">
                Experience the rich flavors of Arabic cuisine with authentic dishes, aromatic spices, and timeless Middle Eastern culinary tradition.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          className="group relative h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden rounded-2xl cursor-pointer shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] hover:shadow-[0_25px_80px_-10px_rgba(0,0,0,0.5)] transition-all duration-500 border border-amber-200/30 bg-white backdrop-blur-sm"
        >
          ...
          <div className="absolute inset-0">
            <Image
              src="/Nahas-al-Blad.webp"
              alt="Rovee Arabic Cuisine"
              fill
