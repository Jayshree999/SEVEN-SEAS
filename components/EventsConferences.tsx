    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-5 md:p-6 z-10">
        ...
        <motion.div
          ...
          className="w-full"
        >
          <div className="bg-white/98 backdrop-blur-md px-4 py-2.5 rounded-lg shadow-[0_10px_40px_rgba(0,0,0,0.4)] border border-amber-200/50 text-center">
            <h3 
              className="text-sm md:text-base font-bold text-gray-900 tracking-wide"
              style={{ fontFamily: 'var(--font-playfair)' }}
            >
              {event.title}
            </h3>
