...
export default function SmartFeatures() {
  ...
  return (
    <section className="py-20 md:py-32 px-4 sm:px-6 relative overflow-hidden bg-white">
...
function FeatureCard({
  ...
  return (
    ...
    >
      <div className="relative h-full p-8 bg-white rounded-sm border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-500 flex flex-col items-center text-center overflow-hidden">

        {/* Hover Border Gradient */}
        <div className="absolute inset-0 border-2 border-transparent group-hover:border-amber-100/50 transition-colors duration-500 pointer-events-none" />
        ...
        <div className="relative mb-8">
          ...
          <div className="relative w-24 h-24 rounded-full border border-amber-100 flex items-center justify-center bg-transparent group-hover:bg-amber-50/30 transition-all duration-500">
