...
const companyLinks = [
  ...
  { name: 'Our Apps', href: '/company/apps', icon: '📱' },
  { name: 'Contact', href: '/contact', icon: '📧' },
  { name: 'Corporate Contact', href: '/company/corporate', icon: '🏢' },
  { name: 'Press', href: '/company/press', icon: '📰' },
]
      ...
      <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 text-lg">Learn more about Seven Seas Hotel</p>
          </motion.div>
